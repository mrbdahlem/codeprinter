...
export const Toolbar = ({
    ...
    return (
        <nav className="flex max-h-max flex-wrap items-center bg-gray-500 p-3 align-middle">
            <div className="flex flex-wrap items-center justify-start gap-3 align-middle">
                <FontDropdown
                    fontList={fontList}
